...
function checkWord(word, text) {
  ...
  let isWordInText = regex.test(text);
  return isWordInText;
...
function countEmails(str) {
  let email = new RegExp( /\b[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}\b/g);
  let matches = str.match(email);
